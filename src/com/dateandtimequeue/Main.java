...
public class Main {
    ...
    private static void sellStock() {
        ...
        int count = 1;
        for (Node<CompanyShares> compShare : account.getCompanyShares()) {
        ...
        Node<CompanyShares> selectedStock1 = account.getCompanyShares().get(stockChoice - 1);
        CompanyShares selectedStock = selectedStock1.getData();
